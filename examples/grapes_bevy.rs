...
fn setup(
    ...
    println!("Spawned grapes scene");
    
    // Add a camera very close to the grapes
    commands.spawn((
        Camera3d::default(),
        Transform::from_xyz(0.0, 0.0, 0.15).looking_at(Vec3::ZERO, Vec3::Y),
    ));
    println!("Camera positioned at (0, 0, 0.15)");
